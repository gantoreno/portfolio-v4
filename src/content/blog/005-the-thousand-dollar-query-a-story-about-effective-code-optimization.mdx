...
<DynamicFigure src={MapALight} darkSrc={MapADark}>
...
<DynamicFigure src={MapBLight} darkSrc={MapBDark}>
  Figure B: Precision loss by decimal trimming.
</DynamicFigure>
...
<DynamicFigure src={MapCLight} darkSrc={MapCDark}>
  Figure C: Address clusters on the map.
</DynamicFigure>
