...
APIs are **great**, especially if they're from a third party that has already solved a complex problem that we might be facing at some point &ndash; who doesn't _love_ a good old `npm install @{company_name}/sdk`? Just a few steps and you're up and running, it feels pretty much like magic.
