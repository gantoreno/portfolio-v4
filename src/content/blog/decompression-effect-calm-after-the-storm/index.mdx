...
thumbnail: /assets/img/blog/decompression-effect-calm-after-the-storm.png
...
![Programming can be one of the most mentally demanding careers out there.](./assets/programmer.webp)
...
![Some years into the business, late night work doesn't feel like it used to.](./assets/late.webp)
...
![Stress is a function that changes over time.](./assets/whiteboard.webp)
...
![There's more to life than just work.](./assets/habits.webp)
...
![Effective productivity is also about knowing when to stop.](./assets/stop.webp)
...
![It's about balance, and therefore, discipline.](./assets/balance.webp)
...
"If it's critical, then it must be done", you might think, and you'd be absolutely right, but you also have to ask yourself this: How often is it actually critical? If the answer points to it being pretty often, then, as my <abbr title="Project Manager">PM</abbr> once said:
